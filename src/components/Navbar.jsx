  ...
  return (
    <nav className={`${styles.paddingX} w-full flex flex-col py-5 fixed top-0 z-10 bg-primary`}>
      <div className={`w-full max-w-7xl mx-auto flex gap-4`}>
        ...
        <div className='font-bold bg-gradient-to-r from-yellow-500 via-yellow-200 to-yellow-300 text-clip bg-clip-text text-transparent'>
          <a href="tel:+37129241080">+371 29241080</a>
        </div>
      </div>
